...
<ArticleImage
  ...
  alt="Examples of Blink covers in Blinkist's signature style"
  caption="Blink covers follow a consistent visual style — could AI handle producing them at scale?"
  size="large"
/>
...
The structure worked, but cracks quickly showed. Sometimes the AI introduced typos or produced layouts that were simply unusable. The solution was to keep humans in the loop — but in a way that didn’t add friction.
...
<ArticleImage
  ...
  alt="Job detail view showing AI generated cover variants and review controls"
  size="large"
/>
<ArticleImage
  src="/case-studies/blinkist-cover-tool-2.png"
  alt="Feedback modal for iterating on an AI generated cover"
