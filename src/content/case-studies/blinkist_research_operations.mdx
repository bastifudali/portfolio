...
<ArticleImage
  src="/case-studies/blinkist-research-ops-audit.png"
  alt="High level overview of the initial research operations audit in FigJam"
  caption="Initial research operations audit mapping out tools, workflows, and pain points across teams"
  size="large"
/>
...
To realign everyone, I borrowed a method from Amazon: the **[narrative memo](https://aws.amazon.com/blogs/startups/startup-advice-how-to-write-a-narrative/)**.  
...
<ArticleImage
  src="/case-studies/blinkist-research-ops-proposal.png"
  alt="Screenshot of a Google Docs narrative memo showing structured sections with headings like 'Situation', 'Options', and 'Proposal' with detailed text content underneath"
  caption="The narrative memo that helped align stakeholders on the new research operations approach"
  size="large"
/>
...
<ArticleImage
  src="/case-studies/blinkist-research-ops-dovetail.png"
  alt="Screenshot of Dovetail AI search results for the question 'What did users say about onboarding?'"
  caption="Using Dovetail AI search to start digging into a topic of interest"
  size="large"
/>
...
- Built a **[Voice of the Customer tool](/case-studies/blinkist_replit_app)** to process product feedback and forward it to Slack channels.
- Canceled redundant contracts.
